...
export function WarninIcon() {
    return (
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#999999" stroke="none">
            <path d="M2402 4865 c-184 -42 -353 -152 -456 -299 -55 -77 -1826 -3143 -1872 -3240 -53 -113 -69 -185 -68 -321 0 -94 5 -137 22 -199 68 -240 242 -433 465
